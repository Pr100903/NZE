      ...
      <div className={`privacy-policy fade-in ${isVisible ? 'visible' : ''}`}>
        ...
        <section className="privacy-content">
          ...
          <div className={`privacy-section fade-in-up ${isVisible ? 'visible' : ''}`} style={{ animationDelay: '0.2s' }}>
            ...
            <p>
              We have adopted this Privacy Policy, which determines how we are processing the information collected by NZ Essentials, which also provides the reasons why we must collect certain personal data about you. Therefore, you must read this Privacy Policy before using NZ Essentials website.
            </p>
            <p>
